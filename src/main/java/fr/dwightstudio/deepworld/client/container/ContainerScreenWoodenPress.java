...
public class ContainerScreenWoodenPress extends AbstractContainerScreen<ContainerWoodenMachine<TileEntityWoodenPress>> {

    private ContainerWoodenMachine<TileEntityWoodenPress> containerWoodenPress;

    public ContainerScreenWoodenPress(ContainerWoodenMachine<TileEntityWoodenPress> containerWoodenPress, Inventory playerInventory, Component title) {
