...
public class WoodenLatheRecipe extends DeepworldMachineRecipe {

    // Infos
    public static final IRecipeType<WoodenLatheRecipe> LATHING = IRecipeType.register("wooden_lathe_lathing");
    ...
    public WoodenLatheRecipe(ResourceLocation resourceLocation, String ingredient, int ingredientCount, ItemStack result, int processingTime) {
