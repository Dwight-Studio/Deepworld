...
public class WoodenLatheRecipeSerializer <T extends WoodenLatheRecipe> extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T>{
