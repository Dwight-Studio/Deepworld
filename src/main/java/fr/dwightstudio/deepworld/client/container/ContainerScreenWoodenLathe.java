...
public class ContainerScreenWoodenLathe extends AbstractContainerScreen<ContainerWoodenMachine<TileEntityWoodenLathe>> {
    private ContainerWoodenMachine<TileEntityWoodenLathe> containerWoodenLathe;

    public ContainerScreenWoodenLathe(ContainerWoodenMachine<TileEntityWoodenLathe> containerWoodenLathe, Inventory playerInventory, Component title) {
   ...
   /* public void render(int mouseX, int mouseY, float partialTicks) {
    ...
    protected void renderBg(@NotNull PoseStack poseStack, float partialTicks, int x, int y) {
        ...
        double progressFraction = containerWoodenLathe.fractionOfProcessTimeComplete();
        ...
        double burnRemaining = containerWoodenLathe.getInertiaFraction();
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(Deepworld.MOD_ID, "textures/gui/wooden_lathe.png");
